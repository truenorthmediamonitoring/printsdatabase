...
export default function AddPublicationModal() {
    ...
    <>
        <button
            onClick={() => document.getElementById('publication_modal').showModal()}
            type="button"
            ...
            <span>Add Print Publication</span>
        </button>

        <dialog id="publication_modal" className="modal">
            <div className="modal-box max-w-2xl bg-zinc-50">
                ...
                <div className="mb-5">
                    <h1 className="text-xl text-black font-notosans font-bold leading-none">Add Print Publication</h1>
                    <span className="label-text text-xs text-zinc-800">Enter a Publication name and save.</span>
                </div>
                <AddPublicationForm />
            </div>
        </dialog>
