import { Building, Save, Earth, X, Paperclip, Newspaper } from "lucide-react";
...
export default function AddPublicationForm() {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const endpoint = "/api/savepublication";
                ...
                <div className="flex flex-wrap justify-start items-center gap-4 mb-4">
                    ...
                    <div className="grow">
                        ...
                        <label className="input input-sm flex w-full md:max-w-2xl items-center gap-2 bg-zinc-100 rounded-md shadow-sm">
                            <Newspaper size={15} className="text-red-700" />
                            <input name="publication" type="text" className="grow font-semibold text-black" placeholder="Print Publication name" required />
                        </label>
                    </div>
                </div>
