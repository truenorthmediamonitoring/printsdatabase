...
export default function DelCategoryForm({ id }) {
    ...
    return (
        <>
            <form onSubmit={handleCategoryDeletion}>
                {deleting === false && (
                    <button
                        name="id"
                        value={id}
                        type="submit"
                        className="btn-xs flex justify-start items-center gap-1 bg-red-700 text-white rounded-full font-sans font-semibold text-xs px-2">
