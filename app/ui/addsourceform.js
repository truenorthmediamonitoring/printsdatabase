import { Building, Save, Earth, X, Paperclip, Newspaper, Radio, Tv } from "lucide-react";
...
export default function AddSourceForm() {
    ...
    return (
        <>
                ...
                <div className="flex flex-wrap justify-start items-center gap-4 mb-4">
                    ...
                    <div className="grow">
                        ...
                        <label className="input input-sm flex w-full md:max-w-2xl items-center gap-2 bg-zinc-100 rounded-md shadow-sm">
                            <span>
                                <Radio size={12} className="text-red-700" />
                                <Tv size={12} className="text-red-700" />
                            </span>

                            <input name="source" type="text" className="grow font-semibold text-black" placeholder="Source name" required />
                        </label>
                    </div>
                </div>
            ...
            <ToastAlert
                stateVar={sourceadded}
                textColor="text-army-green"
                text="Source added."
                onClick={() => setsourceadded(false)}
                iconHint="success"
            />
