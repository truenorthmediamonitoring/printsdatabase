...
export default function DelPublicationOnlineForm({ id }) {
    const [deleting, setdeleting] = useState(false);
    const [deleted, setdeleted] = useState(false);
    const [internalerror, setinternalerror] = useState(false);

    const handlePublicationDeletion = async (event) => {
        ...
        const endpoint = "/api/deletepublicationonline";
    ...
    return (
        <>
            <form onSubmit={handlePublicationDeletion}>
                {deleting === false && (
                    <button
                        name="id"
                        value={id}
            ...
            <ToastAlert
                ...
                text="Online publication deleted"
